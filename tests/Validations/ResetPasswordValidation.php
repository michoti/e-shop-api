...
trait ResetPasswordValidation
{
    ...
    public function the_email_fied_should_be_an_email_format()
    {
        ...
        $res->assertUnprocessable()
            ->assertJsonPath('errors.email', ['The email field must be a valid email address.']);
    }
    ...
    public function a_password_field_should_be_follow_the_password_rules()
    {
        ...
        $res->assertUnprocessable()
            ...
            ->assertJsonPath('errors.password.1', 'The password field must contain at least one symbol.')
            ->assertJsonPath('errors.password.2', 'The password field must contain at least one number.');
    }
