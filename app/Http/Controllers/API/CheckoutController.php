...
class CheckoutController extends Controller
{
    ...
    {
        try {
            // Simulated data to replace RajaOngkir API response
            $dummyData = [
                'costs' => [
                    [
                        ...
                        'cost' => [
                            ['value' => 150000, 'etd' => '3-5 days'],
                            ['value' => 220000, 'etd' => '2-3 days'],
                        ]
                    ],
                ]
            ];

            // Simulated currencyFormat function
            ...
            // Formatting the cost values
            foreach ($dummyData['costs'] as $costs_key => $costs) {
                foreach ($costs['cost'] as $cost_key => $cost) {
                    $dummyData['costs'][$costs_key]['cost'][$cost_key]['value'] = currencyFormat($cost['value']);
                }
            }

            // Return the formatted costs
            $formattedCosts = $dummyData['costs'];
